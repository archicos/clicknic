...
public class AddPatient extends javax.swing.JFrame {
    ...
    public AddPatient(User dataLogin) {
    ...
    public void addData(){
        ...
        } else if(dataLogin.getRole().equals("Dokter") || dataLogin.getRole().equals("Admin")) {
            try {
                ...
                if(obatTersedia){
                    ...
                    JOptionPane.showMessageDialog(null, "Pasien berhasil ditambahkan! Silahkan Refresh!", "Data Addition", JOptionPane.INFORMATION_MESSAGE);
                    this.dispose();
                } else {
    ...
    private void initComponents() {
        ...
        lblTitle.setText("TAMBAH PASIEN");
